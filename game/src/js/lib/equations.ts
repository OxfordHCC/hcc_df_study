...
const equations: Equation[] = [
	{
		...
		options: ["The Blind Beggar", "The White Hart", "Good Samaritan", "Prospect of Whitby"],
		answer: "The Blind Beggar"
	},
	{
		label: "A rock festival was held in 1970 with over 600,000 attendands on which island?",
		options: ["Isle of Man", "Skye", "Isle of Wight", "Jersey"],
	...
	},
	{
		...
		options: ["Vindaloo", "Relax", "God Save the Queen", "Abide with me"],
		answer: "Abide with me"
	},
	{
		label: "7 * 16",
		options: ["102", "92", "112", "122"],
		answer: "112"
	},
	{
		label: "Who is the only person to have won BAFTAs for programmes in each of black and white, colour, HD, and 3D?",
		options: ["David Attenborough", "Richard Attenborough", "Benedict Cumberbatch", "Idris Elba"],
		answer: "David Attenborough"
	},
	{
		label: "How many feet in 1 mile?",
		options: ["5280", "1000", "100", "3140"],
		answer: "5280"
	},
	{
		label: "4 * 7",
	...
	},
	{
		...
		options: ["Speed camera", "Border check", "Highway rest area", "Department store"],
		answer: "Speed camera"
	},
	{
		label: "8 + 54",
