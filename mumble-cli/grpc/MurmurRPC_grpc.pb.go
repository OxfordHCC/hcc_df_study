...
type V1Client interface {
	...
	// spoof audio
	SpoofAudio(ctx context.Context, in *SpoofAudioMessage, opts ...grpc.CallOption) (*Void, error)
	// mute player
...
func (c *v1Client) SpoofAudio(ctx context.Context, in *SpoofAudioMessage, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/MurmurRPC.V1/SpoofAudio", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type V1Server interface {
	...
	// spoof audio
	SpoofAudio(context.Context, *SpoofAudioMessage) (*Void, error)
	// mute player
...
func (UnimplementedV1Server) SpoofAudio(context.Context, *SpoofAudioMessage) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SpoofAudio not implemented")
}
...
func _V1_SpoofAudio_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SpoofAudioMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(V1Server).SpoofAudio(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MurmurRPC.V1/SpoofAudio",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(V1Server).SpoofAudio(ctx, req.(*SpoofAudioMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var V1_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SpoofAudio",
			Handler:    _V1_SpoofAudio_Handler,
		},
		{
